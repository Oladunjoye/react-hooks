...
[an isolated page](http://localhost:4000/isolated/exercise/04-classes.js) to
practice that.
...
Open [http://localhost:4000/isolated/final/04.extra-3.js](http://localhost:4000/isolated/final/04.extra-3.js) and see that the extra
